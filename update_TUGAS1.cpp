...
/* saya pake mac bang, makanya saya hapus conio.h & getch krn tdk bs dijalankan */
#include <stdio.h>
#include <iostream>
#include <string.h>
...
{
    int x;
    cout << "Pilih data yang ingin di update (1 s.d. 5): ";
    cin >> x;
    if (x<=n && x>0)
    {
        cout << "Update Nama : ";
    ...
    {
         cout << "\n data yang ingin diupdate tidak ada...!!!\n";
    }
}